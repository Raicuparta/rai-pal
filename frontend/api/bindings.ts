...
export type InstalledGame = { id: string; name: string; providerId: ProviderId; discriminator: string | null; steamLaunch: SteamLaunchOption | null; executable: GameExecutable; thumbnailUrl: string | null; installedModVersions: { [key: string]: string | null }; gameMode: GameMode; startCommand: StartCommand | null }
export type ModKind = "Installable" | "Runnable"
export type RunnableModData = { path: string; args: string[] }
export type StartCommandProgram = { StringCommand: string } | { PathCommand: string }
...
export type StartCommand = { program: StartCommandProgram; args: string[] | null }
