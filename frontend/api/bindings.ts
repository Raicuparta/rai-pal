...
export const commands = {
	...
	async configureMod(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("configure_mod", { installedGame, modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async deleteMod(modId: string): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("delete_mod", { modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async deleteSteamAppinfoCache(): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("delete_steam_appinfo_cache"),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async downloadMod(modId: string): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("download_mod", { modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getModLoaders(): Promise<
		Result<{ [key in string]: ModLoaderData }, Error>
	> {
		try {
	...
	): Promise<Result<ProviderData, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("get_provider_data", { providerId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getProviderGames(providerId: ProviderId): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("get_provider_games", { providerId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getRemoteMods(): Promise<
		Result<{ [key in string]: RemoteMod }, Error>
	> {
		try {
	...
	async installMod(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("install_mod", { installedGame, modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async openGameFolder(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("open_game_folder", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async openGameModsFolder(
		installedGame: InstalledGame,
	): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("open_game_mods_folder", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async openInstalledModFolder(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("open_installed_mod_folder", {
					installedGame,
					modId,
				}),
			};
	...
	async openModFolder(modId: string): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("open_mod_folder", { modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async openModLoaderFolder(modLoaderId: string): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("open_mod_loader_folder", { modLoaderId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async refreshGame(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("refresh_game", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async removeGame(installedGame: InstalledGame): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("remove_game", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async runProviderCommand(
		ownedGame: OwnedGame,
		commandAction: ProviderCommandAction,
	): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("run_provider_command", {
					ownedGame,
					commandAction,
				}),
			};
	...
	async runRunnableWithoutGame(modId: string): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("run_runnable_without_game", { modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async startGameExe(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("start_game_exe", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async startGame(installedGame: InstalledGame): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("start_game", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async uninstallAllMods(
		installedGame: InstalledGame,
	): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("uninstall_all_mods", { installedGame }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async uninstallMod(
		...
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("uninstall_mod", { installedGame, modId }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async setInstalledGamesFilter(
		filter: InstalledGamesFilter,
	): Promise<Result<null, Error>> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("set_installed_games_filter", { filter }),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getInstalledGamesFilter(): Promise<
		Result<InstalledGamesFilter, Error>
	> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("get_installed_games_filter"),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
	...
	async getAllInstalledGamesFilters(): Promise<
		Result<InstalledGamesFilter, Error>
	> {
		try {
			return {
				status: "ok",
				data: await TAURI_INVOKE("get_all_installed_games_filters"),
			};
		} catch (e) {
			if (e instanceof Error) throw e;
			else return { status: "error", error: e as any };
...
export type InstalledGame = {
	...
	installedModVersions: { [key in string]: string };
	discriminator: string | null;
	thumbnailUrl: string | null;
	ownedGameId: string | null;
	startCommand: ProviderCommand | null;
};
export type InstalledGamesFilter = {
	providers: { [key in ProviderId]: boolean };
	tags: { [key in GameTag]: boolean };
	architectures: { [key in Architecture]: boolean };
	unityScriptingBackends: { [key in UnityScriptingBackend]: boolean };
	engines: { [key in EngineBrand]: boolean };
};
...
export type OwnedGame = {
	...
	thumbnailUrl: string | null;
	tags: GameTag[];
	providerCommands: { [key in ProviderCommandAction]: ProviderCommand };
	fromSubscriptions: GameSubscription[];
};
...
export type ProviderData = {
	installedGames: { [key in string]: InstalledGame };
	ownedGames: { [key in string]: OwnedGame };
};
export type ProviderId = "Steam" | "Manual" | "Itch" | "Epic" | "Gog" | "Xbox";
export type RemoteGame = {
	title: string | null;
	engines: GameEngine[] | null;
	ids: { [key in IdKind]: string[] };
	subscriptions: GameSubscription[] | null;
};
