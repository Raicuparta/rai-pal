...
export type OwnedGame = { id: string; provider: ProviderId; name: string; releaseDate: bigint | null; thumbnailUrl: string | null; gameMode: GameMode | null; appType: AppType | null; providerCommands: { [key in ProviderCommandAction]: ProviderCommand } }
...
export type SyncRemoteGames = RemoteGame[]
