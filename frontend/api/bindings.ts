...
export const commands = {
	...
	removeGameDirectory: (path: string) => __TAURI_INVOKE<null>("remove_game_directory", { path }),
	getManualGameDirectories: () => __TAURI_INVOKE<string[]>("get_manual_game_directories"),
...
export type GameMod = {
	...
	optionalDependencies: ModDependency[] | null,
	requiredDependencies: ModDependency[] | null,
