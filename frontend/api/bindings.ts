...
export type DbGame = { providerId: ProviderId; gameId: string; externalId: string; displayTitle: string; titleDiscriminator: string | null; normalizedTitles: string; thumbnailUrl: string | null; releaseDate: bigint | null; exePath: string | null; engineBrand: EngineBrand | null; engineVersion: string | null; unityBackend: UnityScriptingBackend | null; architecture: Architecture | null; tags: JsonSet<GameTag> }
