...
export type DbGame = { providerId: ProviderId; gameId: string; externalId: string; displayTitle: string; titleDiscriminator: string | null; thumbnailUrl: string | null; releaseDate: bigint | null; exePath: PathData | null; engineBrand: EngineBrand | null; engineVersion: string | null; unityBackend: UnityBackend | null; architecture: Architecture | null; tags: JsonData<GameTag[]>; providerCommands: JsonData<Partial<{ [key in ProviderCommandAction]: ProviderCommand }>> }
