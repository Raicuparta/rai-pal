...
export type ProviderId = "Steam" | "Manual" | "Itch" | "Epic" | "Gog" | "Xbox" | "Ubisoft"
export type RemoteGame = { title: GameTitle | null; engines: GameEngine[] | null; providerIds: { [key in ProviderId]: string[] } }
